"""
Django settings for anaabkari project.
...
SECRET_KEY = 'django-insecure-euj*sq5dsk&h@58h5##mlbst(0rdwb@pb3g2pc1vzv(g*5esc$'
...
WSGI_APPLICATION = 'anaabkari.wsgi.application'
